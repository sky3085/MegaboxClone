...
$(function () {
            ...
            $('li.movie-group').hover(function () {
                $(this).children().children().children().next("div").css("display","block");
                
            }, function () {
            	$(this).children().children().children().next("div").css("display","none");
            	
            })

            /*하트버튼*/
            $("button.heart-boxoffice").click(function(){
